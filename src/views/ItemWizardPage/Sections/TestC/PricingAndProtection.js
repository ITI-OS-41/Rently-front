...
const validationSchema = yup.object({
  hourly: yup.number().positive(),
  daily: yup.number().positive().required("This field is required"),
  monthly: yup.number().positive(),
  weekly: yup.number().positive(),
});
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={3}>
                      <TextField
                        ...
                        error={touched.hourly && Boolean(errors.hourly)}
                        helperText={touched.hourly && errors.hourly}
                      />
                    </Grid>
                    <Grid item xs={2}>
                      <InputLabel
                    ...
                    <Grid item xs={3}>
                      <TextField
                        ...
                        onBlur={handleBlur}
                        onChange={handleChange}
                        error={touched.daily && Boolean(errors.daily)}
                        helperText={touched.daily && errors.daily}
                      />
                    </Grid>
                  </Grid>
                  <Grid container spacing={4}>
                    ...
                    <Grid item xs={3}>
                      <TextField
                        ...
                        onBlur={handleBlur}
                        onChange={handleChange}
                        error={touched.weekly && Boolean(errors.weekly)}
                        helperText={touched.weekly && errors.weekly}
                      />
                    </Grid>
                    <Grid item xs={2}>
                      <InputLabel
