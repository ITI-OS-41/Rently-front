                ...
                {isLoading ? <LoadingContainer/> : (<GridContainer>
                    ...
                    <GridItem md={4} sm={6}>
                        {images.length ?
                            ...
                            /> : <img src={defaultImage} style={{width: '100%', height: 'auto'}} alt={item.name}/>}
                    </GridItem>
                    <GridItem md={8} sm={6}>
                                ...
                                },
                                {
                                    ...
                                    content: (
                                        <p>
                                            ...
                                            <Link to={`/user/${item.owner._id}`} className={classes.storeName}>View
                                                store</Link>
                                        </p>
                                    ),
                                },
                        ...
                        <small><em><strong>Starting
                            at </strong>EGP${Math.min(...Object.values(item.price))}.00</em></small><br/>
                        ...
                        <ItemRent item={item}
                                  priceSelect={priceSelect > 0 ? priceSelect : Math.min(...Object.values(item.price))}
                                  user={user._id}/>
